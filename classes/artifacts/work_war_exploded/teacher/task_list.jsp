	...
	<center>
		<table width="100%" border="0" cellpadding="3" cellspacing="1"
			...
			<tr bgcolor=black onmouseover="this.bgColor='f1f1f1'"
				onmouseout="this.bgColor='FFFFFF'" style='cursor: hand' title=""></tr>
				<td><%=t.getNumber()%></td>
				<td><%=t.getName()%></td>
				<td><%=t.getType()%></td>
				<td><%=t.getKind()%></td>
		...
		<table align="left" border="0" cellpadding="3" cellspacing="1"
			...
			<tbody>
				...
				<tr color="#f3f6fa">
					...
					<td>&nbsp; <a href="/work/teacher?type=3&pageNo=1"><b>|</b>&lt; </a>&nbsp;
					</td>
					<td>&nbsp; <a href="/work/teacher?type=3&pageNo=<%=pageNo - 1%>">&lt;</a>&nbsp;
					</td>
					...
					%>
					<%-- <td>&nbsp; <a href="/work/teacher?type=3&pageNo=<%=i%>">[<%=i%>]
					</a>&nbsp;
					</td> --%>
					<%
						}
					...
					<td>&nbsp; <a href="/work/teacher?type=3&pageNo=<%=totalPages%>">&gt;<b>|</b>
					</a>&nbsp;
					</td>

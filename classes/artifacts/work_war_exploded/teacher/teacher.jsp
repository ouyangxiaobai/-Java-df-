...
<BODY bgcolor="#E1E6F6" scroll="no" topmargin="0" bottom="0"
	leftmargin="0" rightmargin="0">
	<TABLE height="100%" cellSpacing="0" cellPadding="0" border="0"
		width="100%">
		<TR> 
			<TD bgcolor="#E1E6F6" colSpan="3"><IFRAME
		...
		<TR>
			<TD bgcolor="#E1E6F6" width="170" height="100%" rowspan="2"
				align="middle" id="frameTitle"><IFRAME
			...
			<TD bgcolor="#E1E6F6" width="10" height="100%" rowspan="2"
				align="center" onClick="switchSysBar()"><FONT bgcolor="#E1E6F6"

...
<%
	...
	if (student != null) {
		out.println("学生相关功能已开启！请先关闭学生功能！");
		return;
	}
%>
<body>
	...
	<%
		...
		if (action != null && action.trim().equals("delete")) {
			if (MsgManager.delete("教师相关功能")) {
				out.println("教师功能关闭成功！<br>");
				return;
			} else {
				out.println("教师功能关闭未成功！");
				return;
			}
		}
		if (teacher != null) {
			out.println("教师相关功能已经开启！<br><br><br>");
			out.println(
					"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='control_teacher.jsp?Action=delete' style='color:red; font-size: 24px; text-decoration: underline;'>关闭教师功能</a>");
			return;
		}
			...
			<tr>
				<td height="24" nowrap bgcolor="#E1E6F6"><table width="100%"
						...
						<tr>
							...
							<td><div align="center"><font color=black>要开启教师相关功能点击下面的提交按钮即可！公告内容可以修改，标题不可修改！</div>
							</td>
						</tr>
						<tr>
							<td height="20" align="right"><font color=black>标题：</td>
							<td><div align="left">
									<input name="title" id="title" readonly="readonly"
										value="教师相关功能" />
								</div></td>
							<tr>
								<td height="20" align="right" valign="top"><font color=black>公告内容：</td>
								<td><div align="left">
										<textarea name="content" cols="60" rows="8" class="textfield"
											id="content" style="WIDTH: 580;">请各位教师登录系统，发布、修改、删除自己的课题！</textarea>
									</div></td>
							</tr>
							<tr>
